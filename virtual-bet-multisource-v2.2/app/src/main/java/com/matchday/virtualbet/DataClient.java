...
public final class DataClient {
    ...
    public static ArrayList<JSONObject> fixtures(int mode,int source,String k,Scope scope)throws Exception{
        ...
        if(mode==1){if(source==0)return FootballData.beidan(get("https://trade.500.com/bjdc/","GB18030",scope),k);return FootballData.titan(get(url,"GB18030",scope),k,1);}
    ...
    public static ArrayList<JSONObject> results(String k,int mode,int source,Scope scope)throws Exception{
        ArrayList<JSONObject> fixtures;if(mode==2)fixtures=FootballData.globalTitan(get(titanUrl(k),"GB18030",scope),k);else fixtures=source==0?FootballData.titan(get(titanUrl(k),"GB18030",scope),k,mode):source==1?FootballData.sina(get(sinaUrl(k),"UTF-8",scope),k):FootballData.five(get(fiveUrl(k),"GB18030",scope),k);
